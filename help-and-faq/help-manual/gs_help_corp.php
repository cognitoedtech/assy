	...
	<div class="container text-justify">
		<div class="row-fluid">
			<div class="col-md-3 bs-docs-sidebar">
				<ul id="sidebar" class="nav nav-list-new bs-docs-sidenav fixed">
					...
					<li><a href="#myaccount"><i style="float: right"
							class="icon-arrow-right-5"></i> My Account and Billing</a></li>
					<li><a href="#mycoordinators"><i style="float: right"
							class="icon-arrow-right-5"></i>My Coordinators</a></li>
			...
			<div class="col-md-9">
				...
				<p>
					<a href="http://<?php echo(CSiteConfig::ROOT_URL);?>/index.php"><?php echo(CConfig::SNC_SITE_NAME);?>.com</a>
					...
					attention. With the help of <a
						href="http://<?php echo(CSiteConfig::ROOT_URL);?>/index.php"><?php echo(CConfig::SNC_SITE_NAME);?>.com</a>
				...
				<div class="well text-center">
					<a href="images/dashboard.jpg" target="_blank"><img
						src="images/dashboard.jpg" height="600" width="700" /></a>
				</div>
				</section>
				...
				<div class="well text-center">
					<a href="images/sneek_kb.jpg" target="_blank"><img
						src="images/sneek_kb.jpg" height="600" width="700" /></a>
				</div>
				...
				<div class="well text-center">
					<a href="images/sneek_pb.jpg" target="_blank"><img
						src="images/sneek_pb.jpg" height="600" width="700" /></a>
				</div>
				</section>
				...
				<p>This section is related to your personal data. From this section
					...
					edit details about your organization etc. Your billing information
					is also displayed here along with the facility of recharging your
					account.</p>
				...
				<div class="well text-center">
					<a href="images/view_personal_detail.jpg" target="_blank"><img
						src="images/view_personal_detail.jpg" height="600" width="700" /></a>
				</div>

				<h5 style="color: black">Editing personal Details:</h5>
				<div class="well text-center">
					<a href="images/edit_personal_detail.jpg" target="_blank"><img
						src="images/edit_personal_detail.jpg" height="600" width="700" /></a>
				</div>
				...
				<div class="well text-center">
					<a href="images/view_acc_security.jpg" target="_blank"><img
						src="images/view_acc_security.jpg" height="600" width="700" /></a>
				</div>

				<h5 style="color: black">Editing Account Security:</h5>
				<div class="well text-center">
					<a href="images/edit_acc_security.jpg" target="_blank"><img
						src="images/edit_acc_security.jpg" height="600" width="700" /></a>
				</div>
				...
				<div class="well text-center">
					<a href="images/view_org_details.jpg" target="_blank"><img
						src="images/view_org_details.jpg" height="600" width="700" /></a>
				</div>
				...
				<br />
				<div class="well text-center">
					<a href="images/edit_org_details.jpg" target="_blank"><img
						src="images/edit_org_details.jpg" height="600" width="700" /></a>
				</div>
				<h5>Logo Type - Image</h5>
				<div class="well text-center">
					<a href="images/org_img.jpg" target="_blank"><img
						src="images/org_img.jpg" height="300" width="400" /></a>
				</div>
				...
				<p>
					This option shows you the complete billing information related to
					your account. Important points are described below. You can reach
					here using - <strong>My Account <i class="icon-arrow-right"></i>
						Billing Information.
					</strong>
				</p>
				<ol>
					<li style="font-size: 16px"><strong><?php echo(CConfig::SNC_SITE_NAME);?> Question Source Rate:</strong> It is the rate per test for a single candidate if you choose <?php echo(CConfig::SNC_SITE_NAME);?> question source to conduct your test. <br /></li>
					
					<li style="font-size: 16px"><strong>Personal Question Source Rate:</strong>
						It is the rate per test for a single candidate if you choose to
						conduct your test using your personal question source. <br /></li>
					
					<li style="font-size: 16px"><strong>Projected Balance:</strong> It
						is the net available balance remaining in your account, it's
						calculation is based on all the test you have scheduled, whether
						candidate has attempted the test or not. <br /></li>
					
					<li style="font-size: 16px"><strong>Balance:</strong> It is net
						balance remaining in your account. It's calculation is based on
						all the tests which the candidates have attempted. It is always
						greater than or equal to the projected balance. <br /></li>
					
					<li style="font-size: 16px"><strong>Last Billed:</strong> Date of
						your last bill. <br /></li>
					
					<li style="font-size: 16px"><strong>Business Associate:</strong> Name of our business associate through which you have opted <?php echo(CConfig::SNC_SITE_NAME);?>. <br /></li>
				...
				<p>This page also shows you the account billing history, in tabular
					format. It shows following information.</p>
				<ol>
					<li style="font-size: 16px"><strong>Transaction ID:</strong> Unique
						identification of your last transaction.<br /></li>
					
					<li style="font-size: 16px"><strong>Recharge Amount:</strong>
						Amount of Recharge. <br /></li>
					
					<li style="font-size: 16px"><strong>Payment Mode:</strong> Mode of
						payment, (Cheque, DD or NEFT). <br /></li>
					
					<li style="font-size: 16px"><strong>Payment Agent:</strong> Agent
						through with you have submitted payment. <br /></li>
					
					<li style="font-size: 16px"><strong>Payment Ordinal:</strong> It is
						Cheque / Demand Draft number or NEFT Transaction ID through which
						payment has been deposited. <br /></li>
					
					<li style="font-size: 16px"><strong>Payment Date:</strong> Date on
						which you have deposited payment. <br /></li>
					
					<li style="font-size: 16px"><strong>Realization Date:</strong> Date
						on which payment has been actually transferred to our account. <br /></li>
					
				</ol>
				<div class="well text-center">
					<a href="images/billing_info.jpg" target="_blank"><img
						src="images/billing_info.jpg" height="600" width="700" /></a>
				</div>

				<!--	====Account Recharge====	-->

				<h3 style="color: black">Account Recharge</h3>
				<p>This page shows you options to recharge your account. It has
					following options:</p>
				<ol>
					<li style="font-size: 16px"><strong>U.S. Dollars:</strong></li>
					<p>If you are corporate whose registered office is out of India,
						you have to choose this option. It shows you the payment gateway
						via Paypal. You can proceed with this option and deposit your
						amount. Once realized, balance will be shown in your billing info
						option.</p>
					<div class="well text-center">
						<a href="images/account_rec_usdollar.jpg" target="_blank"><img
							src="images/account_rec_usdollar.jpg" height="600" width="700" /></a>
					</div>
					<br />
					<br />

					<li style="font-size: 16px"><strong>Indian Rupees:</strong></li>
					<p>If you are a corporate whose registered office is in India, you
						have to choose this option.You can deposit your payment via
						Cheque, DD, or NEFT.</p>

					<ul type="disc">
						<li style="font-size: 16px"><strong>Pay Via Cheque: </strong> If
							you choose to pay via Cheque, keep your cheque ready, this page
							shows you to fill the details of your cheque. Page shows to fill
							the options for</li>

						<ul type="circle">
							<br />
							<li style="font-size: 16px"><strong>Amount:</strong> Total
								recharge amount.</li>
							<li style="font-size: 16px"><strong>Cheque Number:</strong>
								Cheque Number mentioned on Cheque.</li>
							<li style="font-size: 16px"><strong>Date on Cheque:</strong> Date
								mentioned on Cheque.</li>
							<li style="font-size: 16px"><strong>Drawn-On Bank:</strong> Bank
								Name.</li>
							<br />
							<p>
								<strong><em>NOTE:</strong>Once you have filled all the details
								you have to click process,once processed successfully, you will
								be provided a transaction id, Note that transaction ID.You need
								to write down that id behind cheque before sending to us.</em>
							</p>
							<div class="well text-center">
								<a href="images/account_rec_cheque.jpg" target="_blank"><img
									src="images/account_rec_cheque.jpg" height="600" width="700" /></a>
							</div>
						</ul>
						<br />
						<li style="font-size: 16px"><strong>Pay Via Demand Draft: </strong>If
							you choose to pay via DD (Demand Draft), keep your DD ready, this
							page shows you to fill the details of your cheque.Page shows to
							fill the options for</li>

						<ul type="circle">
							<br />
							<li style="font-size: 16px"><strong>Amount:</strong> Total
								recharge amount.</li>
							<li style="font-size: 16px"><strong>DD Number:</strong> DD Number
								mentioned on Demand Draft.</li>
							<li style="font-size: 16px"><strong>Date on DD:</strong> Date on
								Demand Draft.</li>
							<li style="font-size: 16px"><strong>Drawn-On Bank:</strong> Bank
								Name.</li>
							<br />
							<p>
								...
								you have to click process, once processed successfully,you will
								be provided a transaction id,Note that transaction ID. You need
								to write down that id behind DD before sending to us. </em>
							</p>
							<div class="well text-center">
								<a href="images/account_rec_dd.jpg" target="_blank"><img
									src="images/account_rec_dd.jpg" height="600" width="700" /></a>
							</div>
						</ul>
						<br />
						<li style="font-size: 16px"><strong>Payment Instructions for
								Check/DD Payment:</strong>Please read and follow following
							payment instructions carefully.</li>

						<ul type="circle">
							<br />
							<li style="font-size: 16px">Payment should always made in favor
								of "Mastishka Intellisys Private Limited", Cheque / Demand Draft
								should be payable at Indore (M.P.).</li>
							<li style="font-size: 16px">Write down your registered Email-ID
								behind Cheque / Demand Draft.</li>
							<li style="font-size: 16px">Post the Cheque / Demand Draft at
								following (registered) address.</li>
							<br />
							<div class="add">
								Mastishka Intellisys Private Limited<br /> 95, Veena Nagar<br />
								Opposite Bombay Hospital<br /> Ring Road, Indore 452010, India<br />
								Ph: +91 98266 00457, +91 90395 79039
							</div>
						</ul>
						<br />
						<li style="font-size: 16px"><strong>Pay via NEFT (National
								Electronic Funds Transfer):</strong>If you have paid amount via
							NEFT, then enter following NEFT details.</li>

						<ul type="circle">
							<br />
							<li style="font-size: 16px"><strong>Amount:</strong> Recharge
								Amount.</li>
							<li style="font-size: 16px"><strong>NEFT Transaction ID:</strong>
								Unique ID generated when you did NEFT transfer.</li>
							<li style="font-size: 16px"><strong>Date of Payment:</strong>
								Payment Date.</li>
							<li style="font-size: 16px"><strong>Bank:</strong> Bank, through
								which you have processed the payment.</li>
							<br />
							<div class="well text-center">
								<a href="images/account_rec_neft.jpg" target="_blank"><img
									src="images/account_rec_neft.jpg" height="600" width="700" /></a>
							</div>
						</ul>
						<br />
						<li style="font-size: 16px"><strong>NEFT Payment Instructions:</strong>
							Please Read and follow following NEFT payment instructions
							carefully.</li>

						<ul type="circle">
							<br />
							<li style="font-size: 16px"><strong>Payment should always made in
									favor of,</strong></li>
							<br />
							<div class="add">
								Account Name: "Mastishka Intellisys Private Limited"<br /> Account
								Number: 04 0420 0000 4883<br /> IFSC Code: HDFC0000404<br /> Bank:
								HDFC Bank
							</div>
							<br />
							<p>
								<strong><em>NOTE:</strong>Once you process the NEFT details, a Transaction ID will be generated by <?php echo(CConfig::SNC_SITE_NAME);?>.Use that id for your future reference.</em>
							</p>
				...
				<p>
					This section will provide you to add coordinator. Coorporate user
					can register or manage <b>"Coordinators"</b> in his survilience
					with same functionalities except account recharge.
				</p>

				<!--	====Register Coordinator====	-->

				<h3 style="color: black">Register Coordinator</h3>
				<p>In this section you have to enter all the details of coordinator
					that has to be registered. Account of coordinator can be recharged
					by transferring amount to his/her account.
				
				
				<div class="well text-center">
					<a href="images/mycoor_register.jpg" target="_blank"><img
						src="images/mycoor_register.jpg" height="600" width="700" /></a>
				</div>

				<!--	====Manage Coordinator====	-->

				<h3 style="color: black">Manage Coordinator</h3>
				<p>In this section you can manage coordinators by clicking "edit"
					option alongside.</p>
				<ol>
					<li style="font-size: 16px"><strong>Name :</strong> This field
						shows the name of the registered coordinators.</li>
					<br />
					<li style="font-size: 16px"><strong>Contact Number :</strong> This
						field shows the contact number to particular coordinator.</li>
					<br />
					<li style="font-size: 16px"><strong>E-mail ID :</strong> This field
						displays the E-mail ID of the coordinator.</li>
					<br />
					<li style="font-size: 16px"><strong>Location :</strong> This field
						displays the city or state to which the coordinator belongs.</li>
					<br />
					<li style="font-size: 16px"><strong>Department :</strong> The
						department of coordinator is displayed in this field.</li>
					<br />
					<li style="font-size: 16px"><strong>Balance :</strong> It is net
						balance remaining in your account. It's calculation is based on
						all the tests which the candidates have attempted.</li>
					<br />
					<li style="font-size: 16px"><strong>Projected Balance :</strong> It
						is the net available balance remaining in your account, it's
						calculation is based on all the test you have scheduled, whether
						candidate has attempted the test or not.</li>
					<br />
					<li style="font-size: 16px"><strong>Edit Account Details :</strong>
						Edit account details facilitates you to <strong> Reclaim </strong>
						your amount from the coordinator's account or <strong> Recharge </strong>
						coordinator's account.</li>
					<br />
				</ol>
				<div class="well text-center">
					<a href="images/mycoor_manage.jpg" target="_blank"><img
						src="images/mycoor_manage.jpg" height="600" width="700" /></a>
				</div>
				...
				<ol>
					...
					<br />
					<div class="well text-center">
						<a href="images/submitques_normal.jpg" target="_blank"><img
							src="images/submitques_normal.jpg" height="600" width="700" /></a>
					</div>
					<div class="well text-center">
						<a href="images/submitques_normal.jpg" target="_blank"><img
							src="images/submitques_normal.jpg" height="600" width="700" /></a>
					...
					<br />
					<div class="well text-center">
						<a href="images/submitques_rc.jpg" target="_blank"><img
							src="images/submitques_rc.jpg" height="600" width="700" /></a>
					</div>
				</ol>
				...
				<ol>
					...
					<div class="well text-center">
						<a href="images/bulkupload_normal.jpg" target="_blank"><img
							src="images/bulkupload_normal.jpg" height="600" width="700" /></a>
					</div>

					<h5 style="color: black">Bulk Upload for Reading
						Comprehension/Directions:</h5>
					<div class="well text-center">
						<a href="images/bulkupload_rc.jpg" target="_blank"><img
							src="images/bulkupload_rc.jpg" height="600" width="700" /></a>
					</div>
				</ol>
				...
				<ol>
					...
					<br />
					<div class="well text-center">
						<a href="images/dmt_testname.jpg" target="_blank"><img
							src="images/dmt_testname.jpg" height="600" width="700" /></a>
					</div>
					<h5 style="color: black">Error Message Generated</h5>
					<div class="well text-center">
						<a href="images/dmt_testname1.jpg" target="_blank"><img
							src="images/dmt_testname1.jpg" height="600" width="700" /></a>
					</div>
					...
					<br />
					<div class="well text-center">
						<a href="images/dmt_cutoff.jpg" target="_blank"><img
							src="images/dmt_cutoff.jpg" height="300" width="400" /></a>
					</div>
					...
					<br />
					<div class="well text-center">
						<a href="images/dmt_testattr.jpg" target="_blank"><img
							src="images/dmt_testattr.jpg" height="600" width="700" /></a>
					</div>
				</ol>
				...
				<ol>
					...
					<br />
					<div class="well text-center">
						<a href="images/dmt_custominst.jpg" target="_blank"><img
							src="images/dmt_custominst.jpg" height="600" width="700" /></a>
					</div>
					...
					<br />
					<div class="well text-center">
						<a href="images/dmt_testsecurity.jpg" target="_blank"><img
							src="images/dmt_testsecurity.jpg" height="600" width="700" /></a>
					</div>
					...
					<ol>
						...
						<br />
						<div class="well text-center">
							<a href="images/dmt_sectiondetails.jpg" target="_blank"><img
								src="images/dmt_sectiondetails.jpg" height="600" width="700" /></a>
						</div>
						...
						<br />
						<div class="well text-center">
							<a href="images/dmt_selectsubj.jpg" target="_blank"><img
								src="images/dmt_selectsubj.jpg" height="600" width="700" /></a>
						</div>
						<br />
						...
						<ul type="disc">
							...
							<br />
							<div class="well text-center">
								<a href="images/dmt_select_topic.jpg" target="_blank"><img
									src="images/dmt_select_topic.jpg" height="600" width="700" /></a>
							</div>
							<br />
							...
							<br />
							<div class="well text-center">
								<a href="images/dmt_save.jpg" target="_blank"><img
									src="images/dmt_save.jpg" height="600" width="700" /></a>
							</div>
							<br />
							...
							<br />
							<div class="well text-center">
								<a href="images/dmt_saveconformation.jpg" target="_blank"><img
									src="images/dmt_saveconformation.jpg" height="600" width="700" /></a>
							</div>
							<br />
							...
							<ol>
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_delete.jpg" target="_blank"><img
										src="images/managetest_delete.jpg" height="600" width="700" /></a>
								</div>
								<br />
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_details.jpg" target="_blank"><img
										src="images/managetest_details.jpg" height="600" width="700" /></a>
								</div>
								<br />
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_preview.jpg" target="_blank"><img
										src="images/managetest_preview.jpg" height="600" width="700" /></a>
								</div>
								<br />
								<p>
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_previewpage1.jpg" target="_blank"><img
										src="images/managetest_previewpage1.jpg" height="600"
										width="700" /></a>
								</div>
								<br />
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_previewpage2.jpg" target="_blank"><img
										src="images/managetest_previewpage2.jpg" height="600"
										width="700" /></a>
								</div>
								<br />
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_resume.jpg" target="_blank"><img
										src="images/managetest_resume.jpg" height="600" width="700" /></a>
								</div>
								<br />
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_endexam.jpg" target="_blank"><img
										src="images/managetest_endexam.jpg" height="600" width="700" /></a>
								</div>
								<br />
								...
								<br />
								<div class="well text-center">
									<a href="images/managetest_result.jpg" target="_blank"><img
										src="images/managetest_result.jpg" height="600" width="700" /></a>
								</div>
								<br />
							</ol>
							
							<h4 style="color: black">Publishing a Test</h4>
				<p>This feature can be accessed from Manage Tests Option.  Any organization can publish their test to free.ezeeassess.com which empowers end user (candidate) to search and attempt the test, published by any organization which is registered with EZeeAssess. It gives opportunity to Organizations to promote themselves in their potential customer base. If Organization wants to assess any random candidate which is not registered with him then it can use this feature.
				</p>
				
				<br />
				
				<div class="well text-center">
									<a href="images/manage_test_publish.jpg" target="_blank"><img
										src="images/manage_test_publish.jpg" height="600" width="700" /></a>
								</div>
				<br/>
				
				<p>Once checked, you need to provide Keywords and description
				<li> Key Words: Key words specifies the search criteria of your test on EZeeAssess public plateform.  You should specify relevant keywords in order to make your test searchable via keywords</li>
				<li> Description: You can describe your test via this option</li>
					</p>
				<div class="well text-center">
									<a href="images/manage_test_publish1.jpg" target="_blank"><img
										src="images/manage_test_publish1.jpg" height="600" width="700" /></a>
								</div>
				<br/>
				
				<h5 style="color:black">Free Portal </h5>
				<div class="well text-center">
									<a href="images/manage_test_publish3.jpg" target="_blank"><img
										src="images/manage_test_publish3.jpg" height="600" width="700" /></a>
								</div>
				<br/>
				...
				<div class="well text-center">
									<a href="images/manage_test_publish2.jpg" target="_blank"><img
										src="images/manage_test_publish2.jpg" height="600" width="700" /></a>
								</div>
				<br/>
				...
				<div class="well text-center">
									<a href="images/manage_test_publish4.jpg" target="_blank"><img
										src="images/manage_test_publish4.jpg" height="600" width="700" /></a>
								</div>
				...
				<br />
				<p>
					EZeeAssess's Candidateâ€™s Batch Management enables Test Admin to segregate candidates based on various criteria like location, batch time, course type etc. and put them in batches. Batches help in locating candidates and scheduling tests specific for batches.
				...
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/add_batch.jpg" height="600"
						width="700" /></a>
				</div>
				<br />
				...
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/edit_batch_select.jpg" height="600"
						width="700" /></a>
				</div>
				<br />	
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/edit_batch.jpg" height="600"
						width="700" /></a>
				</div>
				<br />		
				...
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/change_batch_1.jpg" height="600"
						width="700" /></a>
				</div>
				<br />	
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/change_batch_2.jpg" height="600"
						width="700" /></a>
				</div>
				<br />	
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/change_batch_3.jpg" height="600"
						width="700" /></a>
				</div>
				<br />	
				<div class="well text-center">
					<a href="images/add_batch.jpg"
						target="_blank"><img
						src="images/change_batch_4.jpg" height="600"
						width="700" /></a>
				</div>
				<br />	
				</section>
				...
				<div class="well text-center">
					<a href="images/register_candidates_uploaddetails.jpg"
						target="_blank"><img
						src="images/register_candidates_uploaddetails.jpg" height="600"
						width="700" /></a>
				</div>
				<br />
				...
				<ol>
					...
					<ul type="disc">
						...
						<br />
						<div class="well text-center">
							<a href="images/save_user_template.jpg" target="_blank"><img
								src="images/save_user_template.jpg" height="600" width="700" /></a>
						</div>
						<p>
						...
						<br />
						<div class="well text-center">
							<a href="images/save_user_bulk.jpg" target="_blank"><img
								src="images/save_user_bulk.jpg" height="600" width="700" /></a>
						</div>
					...
					<div class="well text-center">
						<a href="images/user_upload_link.jpg" target="_blank"><img
							src="images/user_upload_link.jpg" height="600" width="700" /></a>
					</div>
					<p>Once you will email this link, following registration page will
						open once user will click on link.</p>
					<br />
					<div class="well text-center">
						<a href="images/user_reg_link.jpg" target="_blank"><img
							src="images/user_reg_link.jpg" height="600" width="700" /></a>
					</div>
					<p>
				...
				<div class="well text-center">
					<a href="images/user_view_regestered.jpg" target="_blank"><img
						src="images/user_view_regestered.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<ol>
					...
					<br />
					<div class="well text-center">
						<a href="images/test_detail.jpg" target="_blank"><img
							src="images/test_detail.jpg" height="600" width="700" /></a>
					</div>
					<br />
				...
				<div class="well text-center">
					<a href="images/schedule.jpg" target="_blank"><img
						src="images/schedule.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<p>
					...
					<br />
						<?php echo(CConfig::SNC_SITE_NAME);?> provides a unique functionality to its users. In case of low balance in your account <?php echo(CConfig::SNC_SITE_NAME);?> provides the feasibility to remove candidates from the scheduled test provided the candidate should not begin the test. </p>
				<br />
				<div class="well text-center">
					<a href="images/manage_sh_test.jpg" target="_blank"><img
						src="images/manage_sh_test.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<div class="well text-center">
					<a href="images/monitor_test.jpg" target="_blank"><img
						src="images/monitor_test.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<br />
				<div class="well text-center">
					<a href="images/view_sh_test.jpg" target="_blank"><img
						src="images/view_sh_test.jpg" height="600" width="700" /></a>
				</div>
				<br />
				</section>
				...
				<div class="well text-center">
					<a href="images/ra_briefresult.jpg" target="_blank"><img
						src="images/ra_briefresult.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<div class="well text-center">
					<a href="images/custom_select_test.jpg" target="_blank"><img
						src="images/custom_select_test.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<div class="well text-center">
					<a href="images/result3.jpg" target="_blank"><img
						src="images/result3.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<ol>
					...
					<br />
					<div class="well text-center">
						<a href="images/result4.jpg" target="_blank"><img
							src="images/result4.jpg" height="600" width="700" /></a>
					</div>
					<br />
					...
					<br />
					<div class="well text-center">
						<a href="images/result6.jpg" target="_blank"><img
							src="images/result6.jpg" height="600" width="700" /></a>
					</div>
					<br />
					...
					<ul type="disc">
						...
						<br />
						<div class="well text-center">
							<a href="images/result5.jpg" target="_blank"><img
								src="images/result5.jpg" height="600" width="700" /></a>
						</div>
						<br />
						...
						<br />
						<div class="well text-center">
							<a href="images/result7.jpg" target="_blank"><img
								src="images/result7.jpg" height="600" width="700" /></a>
						</div>
						<br />
				...
				<div class="well text-center">
					<a href="images/result8.jpg" target="_blank"><img
						src="images/result8.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<p>This is among the key features of <?php echo(CConfig::SNC_SITE_NAME);?>. You can find out all minute level details of candidate's performance in test. This helps a lot to evaluate the candidate and choose the right one.<br />
					...
					complete Test DNA analysis will be in front of you.<br /> The DNA
				...
				<div class="well text-center">
					<a href="images/test_DNA_1.jpg" target="_blank"><img
						src="images/test_DNA_1.jpg" height="400" width="500" /></a>
				</div>
				<br />

				<h5 style="color: black">Choose Date</h5>
				<div class="well text-center">
					<a href="images/test_DNA_2.jpg" target="_blank"><img
						src="images/test_DNA_2.jpg" height="400" width="500" /></a>
				</div>
				<br />

				<h5 style="color: black">Choose Candidate</h5>
				<div class="well text-center">
					<a href="images/test_DNA_3.jpg" target="_blank"><img
						src="images/test_DNA_3.jpg" height="600" width="700" /></a>
				</div>
				<br />

				<h5 style="color: black">Overall Performance Overview-Graph</h5>
				<div class="well text-center">
					<a href="images/test_DNA_4.jpg" target="_blank"><img
						src="images/test_DNA_4.jpg" height="600" width="700" /></a>
				</div>
				<br />

				<h5 style="color: black">Sectional Overview-Graph</h5>
				<div class="well text-center">
					<a href="images/test_DNA_5.jpg" target="_blank"><img
						src="images/test_DNA_5.jpg" height="600" width="700" /></a>
				</div>
				<br />

				<h5 style="color: black">Subject Overview-Graph</h5>
				<div class="well text-center">
					<a href="images/test_DNA_6.jpg" target="_blank"><img
						src="images/test_DNA_6.jpg" height="600" width="700" /></a>
				</div>
				<br />

				<h5 style="color: black">Performance in Subject-Graph</h5>
				<div class="well text-center">
					<a href="images/test_DNA_7.jpg" target="_blank"><img
						src="images/test_DNA_7.jpg" height="600" width="700" /></a>
				</div>
				<br />

				<h5 style="color: black">Performance in Topic-Graph</h5>
				<div class="well text-center">
					<a href="images/test_DNA_8.jpg" target="_blank"><img
						src="images/test_DNA_8.jpg" height="600" width="700" /></a>
				</div>
				<br />
				...
				<div class="well text-center">
					<a href="images/result9.jpg" target="_blank"><img
						src="images/result9.jpg" height="600" width="700" /></a>
				</div>
				<br />

				<h5 style="color: black">Result Inspection - Reading Comprehension</h5>
				<div class="well text-center">
					<a href="images/result10.jpg" target="_blank"><img
						src="images/result10.jpg" height="600" width="700" /></a>
				</div>
				<br />
				</section>
