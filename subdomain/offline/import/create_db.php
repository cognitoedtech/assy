...
class CCreateDB
{
	...
	{
		$query = sprintf("CREATE TABLE IF NOT EXISTS `test_session` (  `tsession_id` varchar(40) NOT NULL DEFAULT '',  `tschd_id` bigint(20) NOT NULL,  `test_id` bigint(20) NOT NULL,  `user_id` varchar(40) DEFAULT NULL,  `ques_map` text NOT NULL,  `assigned_ques_ids` varchar(4096) DEFAULT NULL,  `attempted_answers` varchar(1024) DEFAULT NULL,  `cur_chronological_time` bigint(20) NOT NULL,  `attempts_remaining` int(11) NOT NULL,  `forced_kill` tinyint(4) NOT NULL DEFAULT '0',  `session_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,  `attempt_history` text NOT NULL,  PRIMARY KEY (`tsession_id`),  KEY `user_id` (`user_id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;");
